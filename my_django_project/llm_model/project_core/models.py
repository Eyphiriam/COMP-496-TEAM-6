...
def upload_to(instance, filename):
    ...
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")  # Format without colons
    result_label = instance.result if instance.result else "Uncategorized"
    return f"uploads/{result_label}_{base}_{timestamp}{ext}"
